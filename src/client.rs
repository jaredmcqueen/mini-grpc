...
//
// use sherpa::sherpa_streamer_client::SherpaStreamerClient;
// use sherpa::StockRequest;
// use tonic::Request;
//
// pub mod sherpa {
...
//
//     let mut client = SherpaStreamerClient::connect("http://[::1]:10000").await?;
//     let mut stream = client
//         .get_trade(Request::new(StockRequest {
//             trade: true,
